...
GameOverState::GameOverState(AssetManager& assetManager, int score, int bestScore) 
    ...
    m_gameOverText.setPosition(400 - gameOverBounds.width / 2, 150);
    ...
    m_scoreText.setPosition(400 - scoreBounds.width / 2, 250);
    ...
    m_bestScoreText.setPosition(400 - bestBounds.width / 2, 290);
    ...
    m_restartText.setPosition(400 - restartBounds.width / 2, 380);
    ...
    m_menuText.setPosition(400 - menuBounds.width / 2, 450);
}
