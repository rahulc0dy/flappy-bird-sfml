...
MenuState::MenuState(AssetManager &assetManager)
    ...
    m_titleText.setPosition({400 - titleBounds.size.x / 2, 150});
    ...
    m_playText.setPosition({400 - playBounds.size.x / 2, 350});
    ...
    m_instructionText.setPosition({400 - instrBounds.size.x / 2, 450});
